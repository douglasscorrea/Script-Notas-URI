m1 = [	"Alejandro Tomas Reyes Alberoni", "Alessandra Rosa Galvao", "Bruno da Silva Volcan", "Bruno Ramos Martins",
		...
		"Joao Pedro Pires Medeiros", "Joao Vitor Dias Wasquevite", "Joao Vitor Lima Araujo da Silva", 
...
m2 = [	"Eduardo Weymar Garcia", "Hiago Schroder Mulling", "Lucas Lima", "Lucas Viscardi Marques", 
		...
		"Murillo Aleixo Mota", "Nicolas Costa Goncalves", "Pedro da Luz Kaster", "Pedro Zanchin Baldissera", 
		"Rafael Machado Candia", "Rafael Montagna Copes", "Renata Torres Abib Bertacco", "Rogerio Farias Otto", 
...
m4 = [	"Gabriel Ferreira Amaral", "Hyhickle Ryozo Umetsubo Goncalves", "Klaus Wagner Irion", 
		...
		"Rafael Carvalho Somenzari Ginjas Camargo", "Rafael Grimmler da Rocha", "Thiago Souza Oliveira", 
		"Vitor de Melo Mandowski", "Willian do Espirito Santo Rodrigues", "Yasmin Rodrigues Martins"]

m1_l3_plagiarism = [	"Alessandra Rosa Galvao", "Frederico Dal Soglio Reckziegel", "Joao Antonio Neves Soares", "Kayara da Silveira Pereira" ,
						"Joao Vitor Dias Wasquevite", "Italo Teixeira da Silveira"]
m2_l3_plagiarism = [	"Rafael Machado Candia", "Vinicius Caldas Wrege", "Rafael Montagna Copes", "Marcelo da Silva Dias", "Thiago Nunes Batista", "Murillo Aleixo Mota"]
m3_l3_plagiarism = [	"Matheus Oliveira da Rosa"]
